...
// $ANTLR 3.5 D:\\Eclipse\\aegiscript_live\\aegiscript.g 2013-04-23 21:15:01
...
public partial class aegiscriptParser : Antlr.Runtime.Parser
{
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:95:1: assignmentStatement : ( IDENT '=' ^ expression ';' | IDENT '=' ^ accessorStatement ';' );
	...
	private AstParserRuleReturnScope<CommonTree, IToken> assignmentStatement()
	{
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:96:2: ( IDENT '=' ^ expression ';' | IDENT '=' ^ accessorStatement ';' )
			int alt13=2;
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:104:1: accessor : a= IDENT ( '[' b+= INTEGER ']' )+ -> ^( ACCESS $a ( $b)+ ) ;
	...
	private AstParserRuleReturnScope<CommonTree, IToken> accessor()
	{
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:105:2: (a= IDENT ( '[' b+= INTEGER ']' )+ -> ^( ACCESS $a ( $b)+ ) )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:105:4: a= IDENT ( '[' b+= INTEGER ']' )+
			{
			DebugLocation(105, 6);
			a=(IToken)Match(input,IDENT,Follow._IDENT_in_accessor485);  
			stream_IDENT.Add(a);

			DebugLocation(105, 14);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:105:14: ( '[' b+= INTEGER ']' )+
			int cnt14=0;
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:105:15: '[' b+= INTEGER ']'
					{
					DebugLocation(105, 15);
					char_literal67=(IToken)Match(input,42,Follow._42_in_accessor488);  
					stream_42.Add(char_literal67);

					DebugLocation(105, 21);
					b=(IToken)Match(input,INTEGER,Follow._INTEGER_in_accessor494);  
					...
					char_literal68=(IToken)Match(input,43,Follow._43_in_accessor496);  
			...
			// 105:38: -> ^( ACCESS $a ( $b)+ )
			{
				...
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:105:41: ^( ACCESS $a ( $b)+ )
				{
				CommonTree root_1 = (CommonTree)adaptor.Nil();
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:112:1: accessorStatement : a= IDENT ( '.' b+= funCallStatement )+ -> ^( FIELD_ACCESS $a ( $b)+ ) ;
	...
	private AstParserRuleReturnScope<CommonTree, IToken> accessorStatement()
	{
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:113:2: (a= IDENT ( '.' b+= funCallStatement )+ -> ^( FIELD_ACCESS $a ( $b)+ ) )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:113:4: a= IDENT ( '.' b+= funCallStatement )+
			{
			DebugLocation(113, 5);
			a=(IToken)Match(input,IDENT,Follow._IDENT_in_accessorStatement536);  
			stream_IDENT.Add(a);

			DebugLocation(113, 12);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:113:12: ( '.' b+= funCallStatement )+
			int cnt15=0;
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:113:13: '.' b+= funCallStatement
					{
					DebugLocation(113, 13);
					char_literal69=(IToken)Match(input,31,Follow._31_in_accessorStatement539);  
					stream_31.Add(char_literal69);

					DebugLocation(113, 18);
					PushFollow(Follow._funCallStatement_in_accessorStatement543);
					b=funCallStatement();
					PopFollow();
			...
			RewriteRuleSubtreeStream stream_b=new RewriteRuleSubtreeStream(adaptor,"token b",list_b);
			root_0 = (CommonTree)adaptor.Nil();
			// 113:40: -> ^( FIELD_ACCESS $a ( $b)+ )
			{
				DebugLocation(113, 43);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:113:43: ^( FIELD_ACCESS $a ( $b)+ )
				{
				CommonTree root_1 = (CommonTree)adaptor.Nil();
	...
	// $ANTLR start "array"
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:120:1: array : ( '[' a= expression ( ',' b+= expression )* ']' -> ^( ARRAY $a ( $b)* ) | '[' ']' );
	[GrammarRule("array")]
	private AstParserRuleReturnScope<CommonTree, IToken> array()
	{
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:121:2: ( '[' a= expression ( ',' b+= expression )* ']' -> ^( ARRAY $a ( $b)* ) | '[' ']' )
			int alt17=2;
			...
			case 1:
				DebugEnterAlt(1);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:121:4: '[' a= expression ( ',' b+= expression )* ']'
				{
				DebugLocation(121, 4);
				char_literal70=(IToken)Match(input,42,Follow._42_in_array582);  
				stream_42.Add(char_literal70);

				DebugLocation(121, 9);
				PushFollow(Follow._expression_in_array587);
				a=expression();
				PopFollow();

				stream_expression.Add(a.Tree);
				DebugLocation(122, 2);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:122:2: ( ',' b+= expression )*
				...
				while (true)
				{
					...
					case 1:
						DebugEnterAlt(1);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:122:3: ',' b+= expression
						{
						DebugLocation(122, 3);
						char_literal71=(IToken)Match(input,29,Follow._29_in_array591);  
						stream_29.Add(char_literal71);

						DebugLocation(122, 9);
						PushFollow(Follow._expression_in_array597);
						b=expression();
						PopFollow();
				...
				char_literal72=(IToken)Match(input,43,Follow._43_in_array600);  
				...
				// 122:28: -> ^( ARRAY $a ( $b)* )
				{
					...
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:122:31: ^( ARRAY $a ( $b)* )
					{
					CommonTree root_1 = (CommonTree)adaptor.Nil();
					...
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:122:43: ( $b)*
					while ( stream_b.HasNext )
					{
						DebugLocation(122, 43);
						adaptor.AddChild(root_1, stream_b.NextTree());
			...
			case 2:
				DebugEnterAlt(2);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:123:4: '[' ']'
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(123, 4);
				char_literal73=(IToken)Match(input,42,Follow._42_in_array618); 
				char_literal73_tree = (CommonTree)adaptor.Create(char_literal73);
				adaptor.AddChild(root_0, char_literal73_tree);
				DebugLocation(123, 7);
				char_literal74=(IToken)Match(input,43,Follow._43_in_array619); 
	...
	// $ANTLR start "term"
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:130:1: term : ( IDENT | '(' expression ')' -> expression | INTEGER | STRING | BOOL | FLOAT | array | accessor | funCallStatement );
	[GrammarRule("term")]
	private AstParserRuleReturnScope<CommonTree, IToken> term()
	{
		...
		IToken INTEGER79 = default(IToken);
		IToken STRING80 = default(IToken);
		IToken BOOL81 = default(IToken);
		IToken FLOAT82 = default(IToken);
		AstParserRuleReturnScope<CommonTree, IToken> expression77 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> array83 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> accessor84 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> funCallStatement85 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		CommonTree INTEGER79_tree = default(CommonTree);
		CommonTree STRING80_tree = default(CommonTree);
		CommonTree BOOL81_tree = default(CommonTree);
		CommonTree FLOAT82_tree = default(CommonTree);
		RewriteRuleITokenStream stream_25=new RewriteRuleITokenStream(adaptor,"token 25");
		RewriteRuleITokenStream stream_26=new RewriteRuleITokenStream(adaptor,"token 26");
		RewriteRuleSubtreeStream stream_expression=new RewriteRuleSubtreeStream(adaptor,"rule expression");
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:131:2: ( IDENT | '(' expression ')' -> expression | INTEGER | STRING | BOOL | FLOAT | array | accessor | funCallStatement )
			int alt18=9;
			...
			case 1:
				DebugEnterAlt(1);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:131:4: IDENT
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(131, 4);
				IDENT75=(IToken)Match(input,IDENT,Follow._IDENT_in_term642); 
			...
			case 2:
				DebugEnterAlt(2);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:132:4: '(' expression ')'
				{
				DebugLocation(132, 4);
				char_literal76=(IToken)Match(input,25,Follow._25_in_term647);  
				stream_25.Add(char_literal76);

				DebugLocation(132, 8);
				PushFollow(Follow._expression_in_term649);
				expression77=expression();
				PopFollow();

				stream_expression.Add(expression77.Tree);
				DebugLocation(132, 19);
				char_literal78=(IToken)Match(input,26,Follow._26_in_term651);  
			...
			case 3:
				DebugEnterAlt(3);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:133:4: INTEGER
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(133, 4);
				INTEGER79=(IToken)Match(input,INTEGER,Follow._INTEGER_in_term660); 
				INTEGER79_tree = (CommonTree)adaptor.Create(INTEGER79);
			...
			case 4:
				DebugEnterAlt(4);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:134:5: STRING
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(134, 5);
				STRING80=(IToken)Match(input,STRING,Follow._STRING_in_term666); 
			...
			case 5:
				DebugEnterAlt(5);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:135:4: BOOL
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(135, 4);
				BOOL81=(IToken)Match(input,BOOL,Follow._BOOL_in_term671); 
				BOOL81_tree = (CommonTree)adaptor.Create(BOOL81);
			...
			case 6:
				DebugEnterAlt(6);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:136:4: FLOAT
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(136, 4);
				FLOAT82=(IToken)Match(input,FLOAT,Follow._FLOAT_in_term676); 
				FLOAT82_tree = (CommonTree)adaptor.Create(FLOAT82);
			...
			case 7:
				DebugEnterAlt(7);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:137:4: array
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(137, 4);
				PushFollow(Follow._array_in_term681);
				array83=array();
				PopFollow();

				adaptor.AddChild(root_0, array83.Tree);

				}
				break;
			case 8:
				DebugEnterAlt(8);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:138:4: accessor
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(138, 4);
				PushFollow(Follow._accessor_in_term686);
				accessor84=accessor();
				PopFollow();

				adaptor.AddChild(root_0, accessor84.Tree);

				}
				break;
			case 9:
				DebugEnterAlt(9);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:139:4: funCallStatement
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(139, 4);
				PushFollow(Follow._funCallStatement_in_term691);
				funCallStatement85=funCallStatement();
				PopFollow();

				adaptor.AddChild(root_0, funCallStatement85.Tree);
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:142:1: negation : ( 'not' ^)* term ;
	...
	private AstParserRuleReturnScope<CommonTree, IToken> negation()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> term87 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:143:2: ( ( 'not' ^)* term )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:143:4: ( 'not' ^)* term
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(143, 9);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:143:9: ( 'not' ^)*
			...
			while (true)
			{
				...
				case 1:
					...
					{
					DebugLocation(143, 9);
					string_literal86=(IToken)Match(input,52,Follow._52_in_negation703); 
			...
			PushFollow(Follow._term_in_negation707);
			term87=term();
			PopFollow();

			adaptor.AddChild(root_0, term87.Tree);
	...
	// $ANTLR start "unary"
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:146:1: unary : ( '+' ^| '-' ^)* negation ;
	[GrammarRule("unary")]
	private AstParserRuleReturnScope<CommonTree, IToken> unary()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> negation90 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:147:2: ( ( '+' ^| '-' ^)* negation )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:147:4: ( '+' ^| '-' ^)* negation
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(147, 4);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:147:4: ( '+' ^| '-' ^)*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:147:5: '+' ^
					{
					DebugLocation(147, 8);
					char_literal88=(IToken)Match(input,28,Follow._28_in_unary721); 
				...
				case 2:
					DebugEnterAlt(2);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:147:12: '-' ^
					{
					DebugLocation(147, 15);
					char_literal89=(IToken)Match(input,30,Follow._30_in_unary726); 
			...
			PushFollow(Follow._negation_in_unary731);
			negation90=negation();
			PopFollow();

			adaptor.AddChild(root_0, negation90.Tree);
	...
	// $ANTLR start "mult"
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:150:1: mult : unary ( ( '*' ^| '/' ^| 'mod' ^) unary )* ;
	[GrammarRule("mult")]
	private AstParserRuleReturnScope<CommonTree, IToken> mult()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> unary91 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:151:2: ( unary ( ( '*' ^| '/' ^| 'mod' ^) unary )* )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:151:4: unary ( ( '*' ^| '/' ^| 'mod' ^) unary )*
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(151, 4);
			PushFollow(Follow._unary_in_mult742);
			unary91=unary();
			PopFollow();

			adaptor.AddChild(root_0, unary91.Tree);
			DebugLocation(151, 10);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:151:10: ( ( '*' ^| '/' ^| 'mod' ^) unary )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:151:11: ( '*' ^| '/' ^| 'mod' ^) unary
					{
					DebugLocation(151, 11);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:151:11: ( '*' ^| '/' ^| 'mod' ^)
					int alt21=3;
					...
					case 1:
						DebugEnterAlt(1);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:151:12: '*' ^
						{
						DebugLocation(151, 15);
						char_literal92=(IToken)Match(input,27,Follow._27_in_mult746); 
					...
					case 2:
						DebugEnterAlt(2);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:151:19: '/' ^
						{
						DebugLocation(151, 22);
						char_literal93=(IToken)Match(input,32,Follow._32_in_mult751); 
					...
					case 3:
						DebugEnterAlt(3);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:151:26: 'mod' ^
						{
						DebugLocation(151, 31);
						string_literal94=(IToken)Match(input,51,Follow._51_in_mult756); 
	...
	// $ANTLR start "add"
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:1: add : mult ( ( '+' ^| '-' ^) mult )* ;
	[GrammarRule("add")]
	private AstParserRuleReturnScope<CommonTree, IToken> add()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> mult96 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> mult99 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:155:2: ( mult ( ( '+' ^| '-' ^) mult )* )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:155:4: mult ( ( '+' ^| '-' ^) mult )*
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(155, 4);
			PushFollow(Follow._mult_in_add774);
			mult96=mult();
			PopFollow();

			adaptor.AddChild(root_0, mult96.Tree);
			DebugLocation(155, 9);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:155:9: ( ( '+' ^| '-' ^) mult )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:155:10: ( '+' ^| '-' ^) mult
					{
					DebugLocation(155, 10);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:155:10: ( '+' ^| '-' ^)
					int alt23=2;
					...
					case 1:
						DebugEnterAlt(1);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:155:11: '+' ^
						{
						DebugLocation(155, 14);
						char_literal97=(IToken)Match(input,28,Follow._28_in_add778); 
					...
					case 2:
						DebugEnterAlt(2);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:155:18: '-' ^
						{
						DebugLocation(155, 21);
						char_literal98=(IToken)Match(input,30,Follow._30_in_add783); 
					...
					PushFollow(Follow._mult_in_add787);
					mult99=mult();
					PopFollow();

					adaptor.AddChild(root_0, mult99.Tree);
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:158:1: relation : add ( ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^) add )* ;
	...
	private AstParserRuleReturnScope<CommonTree, IToken> relation()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> add100 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> add107 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:159:2: ( add ( ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^) add )* )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:159:4: add ( ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^) add )*
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(159, 4);
			PushFollow(Follow._add_in_relation800);
			add100=add();
			PopFollow();

			adaptor.AddChild(root_0, add100.Tree);
			DebugLocation(159, 8);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:159:8: ( ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^) add )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:159:9: ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^) add
					{
					DebugLocation(159, 9);
					...
					case 1:
						DebugEnterAlt(1);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:159:10: '==' ^
						{
						DebugLocation(159, 14);
						string_literal101=(IToken)Match(input,38,Follow._38_in_relation804); 
					...
					case 2:
						DebugEnterAlt(2);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:159:18: '!=' ^
						{
						DebugLocation(159, 22);
						string_literal102=(IToken)Match(input,23,Follow._23_in_relation809); 
					...
					case 3:
						DebugEnterAlt(3);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:159:26: '<' ^
						{
						DebugLocation(159, 29);
						char_literal103=(IToken)Match(input,35,Follow._35_in_relation814); 
					...
					case 4:
						DebugEnterAlt(4);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:159:33: '<=' ^
						{
						DebugLocation(159, 37);
						string_literal104=(IToken)Match(input,36,Follow._36_in_relation819); 
					...
					case 5:
						DebugEnterAlt(5);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:159:41: '>=' ^
						{
						DebugLocation(159, 45);
						string_literal105=(IToken)Match(input,40,Follow._40_in_relation824); 
					...
					case 6:
						DebugEnterAlt(6);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:159:49: '>' ^
						{
						DebugLocation(159, 52);
						char_literal106=(IToken)Match(input,39,Follow._39_in_relation829); 
					...
					PushFollow(Follow._add_in_relation833);
					add107=add();
					PopFollow();

					adaptor.AddChild(root_0, add107.Tree);
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:162:1: expression : relation ( ( '&&' ^| '||' ^) relation )* ;
	...
	private AstParserRuleReturnScope<CommonTree, IToken> expression()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> relation108 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> relation111 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:163:2: ( relation ( ( '&&' ^| '||' ^) relation )* )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:163:4: relation ( ( '&&' ^| '||' ^) relation )*
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(163, 4);
			PushFollow(Follow._relation_in_expression847);
			relation108=relation();
			PopFollow();

			adaptor.AddChild(root_0, relation108.Tree);
			DebugLocation(163, 13);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:163:13: ( ( '&&' ^| '||' ^) relation )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:163:14: ( '&&' ^| '||' ^) relation
					{
					DebugLocation(163, 14);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:163:14: ( '&&' ^| '||' ^)
					int alt27=2;
					...
					case 1:
						DebugEnterAlt(1);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:163:15: '&&' ^
						{
						DebugLocation(163, 19);
						string_literal109=(IToken)Match(input,24,Follow._24_in_expression851); 
					...
					case 2:
						DebugEnterAlt(2);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:163:23: '||' ^
						{
						DebugLocation(163, 27);
						string_literal110=(IToken)Match(input,55,Follow._55_in_expression856); 
					...
					PushFollow(Follow._relation_in_expression860);
					relation111=relation();
					PopFollow();

					adaptor.AddChild(root_0, relation111.Tree);
	...
	private static class Follow
	{
		...
		public static readonly BitSet _IDENT_in_accessor485 = new BitSet(new ulong[]{0x40000000000UL});
		public static readonly BitSet _42_in_accessor488 = new BitSet(new ulong[]{0x10000UL});
		public static readonly BitSet _INTEGER_in_accessor494 = new BitSet(new ulong[]{0x80000000000UL});
		public static readonly BitSet _43_in_accessor496 = new BitSet(new ulong[]{0x40000000002UL});
		public static readonly BitSet _IDENT_in_accessorStatement536 = new BitSet(new ulong[]{0x80000000UL});
		public static readonly BitSet _31_in_accessorStatement539 = new BitSet(new ulong[]{0x8000UL});
		public static readonly BitSet _funCallStatement_in_accessorStatement543 = new BitSet(new ulong[]{0x80000002UL});
		public static readonly BitSet _42_in_array582 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _expression_in_array587 = new BitSet(new ulong[]{0x80020000000UL});
		public static readonly BitSet _29_in_array591 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _expression_in_array597 = new BitSet(new ulong[]{0x80020000000UL});
		public static readonly BitSet _43_in_array600 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _42_in_array618 = new BitSet(new ulong[]{0x80000000000UL});
		public static readonly BitSet _43_in_array619 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IDENT_in_term642 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _25_in_term647 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _expression_in_term649 = new BitSet(new ulong[]{0x4000000UL});
		public static readonly BitSet _26_in_term651 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _INTEGER_in_term660 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _STRING_in_term666 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _BOOL_in_term671 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _FLOAT_in_term676 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _array_in_term681 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _accessor_in_term686 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _funCallStatement_in_term691 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _52_in_negation703 = new BitSet(new ulong[]{0x10040002119040UL});
		public static readonly BitSet _term_in_negation707 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _28_in_unary721 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _30_in_unary726 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _negation_in_unary731 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _unary_in_mult742 = new BitSet(new ulong[]{0x8000108000002UL});
		public static readonly BitSet _27_in_mult746 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _32_in_mult751 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _51_in_mult756 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _unary_in_mult760 = new BitSet(new ulong[]{0x8000108000002UL});
		public static readonly BitSet _mult_in_add774 = new BitSet(new ulong[]{0x50000002UL});
		public static readonly BitSet _28_in_add778 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _30_in_add783 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _mult_in_add787 = new BitSet(new ulong[]{0x50000002UL});
		public static readonly BitSet _add_in_relation800 = new BitSet(new ulong[]{0x1D800800002UL});
		public static readonly BitSet _38_in_relation804 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _23_in_relation809 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _35_in_relation814 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _36_in_relation819 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _40_in_relation824 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _39_in_relation829 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _add_in_relation833 = new BitSet(new ulong[]{0x1D800800002UL});
		public static readonly BitSet _relation_in_expression847 = new BitSet(new ulong[]{0x80000001000002UL});
		public static readonly BitSet _24_in_expression851 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _55_in_expression856 = new BitSet(new ulong[]{0x10040052119040UL});
		public static readonly BitSet _relation_in_expression860 = new BitSet(new ulong[]{0x80000001000002UL});
	}
