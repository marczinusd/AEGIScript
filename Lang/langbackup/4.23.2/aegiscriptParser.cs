...
// $ANTLR 3.5 D:\\Eclipse\\aegiscript_live\\aegiscript.g 2013-04-23 18:13:51
...
public partial class aegiscriptParser : Antlr.Runtime.Parser
{
	...
	private AstParserRuleReturnScope<CommonTree, IToken> whileBody()
	{
		...
		try
		{
			...
			{
			// AST REWRITE
			// elements: statement, 48, expression
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try
		{
			...
			if ((LA11_1==IDENT))
			{
				...
				if ((LA11_2==25))
				{
					...
					else if ((LA11_3==BOOL||LA11_3==FLOAT||(LA11_3>=IDENT && LA11_3<=INTEGER)||LA11_3==STRING||LA11_3==25||LA11_3==28||LA11_3==30||LA11_3==52))
					{
						alt11 = 1;
					}
					else
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:95:1: assignmentStatement : ( IDENT '=' ^ expression ';' | IDENT '=' ^ funCallStatement ';' | IDENT '=' ^ accessor ';' | IDENT '=' ^ array ';' | IDENT '=' ^ accessorStatement ';' );
	...
	private AstParserRuleReturnScope<CommonTree, IToken> assignmentStatement()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> funCallStatement65 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> accessor69 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> array73 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> accessorStatement77 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:96:2: ( IDENT '=' ^ expression ';' | IDENT '=' ^ funCallStatement ';' | IDENT '=' ^ accessor ';' | IDENT '=' ^ array ';' | IDENT '=' ^ accessorStatement ';' )
			int alt13=5;
			...
			if ((LA13_1==IDENT))
			{
				...
				if ((LA13_2==37))
				{
					...
					case IDENT:
						...
						default:
							{
								NoViableAltException nvae = new NoViableAltException("", 13, 4, input, 4);
								DebugRecognitionException(nvae);
								throw nvae;
							}
						}
			...
			case 2:
				DebugEnterAlt(2);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:97:4: IDENT '=' ^ funCallStatement ';'
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(97, 4);
				IDENT63=(IToken)Match(input,IDENT,Follow._IDENT_in_assignmentStatement459); 
				IDENT63_tree = (CommonTree)adaptor.Create(IDENT63);
				adaptor.AddChild(root_0, IDENT63_tree);
				DebugLocation(97, 13);
				char_literal64=(IToken)Match(input,37,Follow._37_in_assignmentStatement461); 
				...
				DebugLocation(97, 15);
				PushFollow(Follow._funCallStatement_in_assignmentStatement464);
				funCallStatement65=funCallStatement();
				PopFollow();

				adaptor.AddChild(root_0, funCallStatement65.Tree);
				DebugLocation(97, 32);
				char_literal66=(IToken)Match(input,34,Follow._34_in_assignmentStatement466); 
			...
			case 3:
				DebugEnterAlt(3);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:98:5: IDENT '=' ^ accessor ';'
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(98, 5);
				IDENT67=(IToken)Match(input,IDENT,Follow._IDENT_in_assignmentStatement472); 
				IDENT67_tree = (CommonTree)adaptor.Create(IDENT67);
				adaptor.AddChild(root_0, IDENT67_tree);
				DebugLocation(98, 14);
				char_literal68=(IToken)Match(input,37,Follow._37_in_assignmentStatement474); 
				...
				DebugLocation(98, 16);
				PushFollow(Follow._accessor_in_assignmentStatement477);
				accessor69=accessor();
				PopFollow();

				adaptor.AddChild(root_0, accessor69.Tree);
				DebugLocation(98, 25);
				char_literal70=(IToken)Match(input,34,Follow._34_in_assignmentStatement479); 
			...
			case 4:
				DebugEnterAlt(4);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:99:5: IDENT '=' ^ array ';'
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(99, 5);
				IDENT71=(IToken)Match(input,IDENT,Follow._IDENT_in_assignmentStatement485); 
				IDENT71_tree = (CommonTree)adaptor.Create(IDENT71);
				adaptor.AddChild(root_0, IDENT71_tree);
				DebugLocation(99, 14);
				char_literal72=(IToken)Match(input,37,Follow._37_in_assignmentStatement487); 
				...
				DebugLocation(99, 16);
				PushFollow(Follow._array_in_assignmentStatement490);
				array73=array();
				PopFollow();

				adaptor.AddChild(root_0, array73.Tree);
				DebugLocation(99, 22);
				char_literal74=(IToken)Match(input,34,Follow._34_in_assignmentStatement492); 
			...
			case 5:
				DebugEnterAlt(5);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:100:4: IDENT '=' ^ accessorStatement ';'
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(100, 4);
				IDENT75=(IToken)Match(input,IDENT,Follow._IDENT_in_assignmentStatement497); 
				IDENT75_tree = (CommonTree)adaptor.Create(IDENT75);
				adaptor.AddChild(root_0, IDENT75_tree);
				DebugLocation(100, 13);
				char_literal76=(IToken)Match(input,37,Follow._37_in_assignmentStatement499); 
				...
				PushFollow(Follow._accessorStatement_in_assignmentStatement502);
				accessorStatement77=accessorStatement();
				PopFollow();

				adaptor.AddChild(root_0, accessorStatement77.Tree);
				DebugLocation(100, 33);
				char_literal78=(IToken)Match(input,34,Follow._34_in_assignmentStatement504); 
	...
	// $ANTLR start "array"
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:103:1: array : ( '[' a= term ( ',' b+= term )* ']' -> ^( ARRAY $a ( $b)* ) | '[' ']' );
	[GrammarRule("array")]
	private AstParserRuleReturnScope<CommonTree, IToken> array()
	{
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:104:2: ( '[' a= term ( ',' b+= term )* ']' -> ^( ARRAY $a ( $b)* ) | '[' ']' )
			int alt15=2;
			...
			if ((LA15_1==42))
			{
				...
				else if ((LA15_2==BOOL||LA15_2==FLOAT||(LA15_2>=IDENT && LA15_2<=INTEGER)||LA15_2==STRING||LA15_2==25))
				{
					alt15 = 1;
				}
				else
			...
			case 1:
				DebugEnterAlt(1);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:104:4: '[' a= term ( ',' b+= term )* ']'
				{
				DebugLocation(104, 4);
				char_literal79=(IToken)Match(input,42,Follow._42_in_array515);  
				stream_42.Add(char_literal79);

				DebugLocation(104, 9);
				PushFollow(Follow._term_in_array520);
				a=term();
				PopFollow();

				stream_term.Add(a.Tree);
				DebugLocation(104, 16);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:104:16: ( ',' b+= term )*
				...
				while (true)
				{
					...
					case 1:
						DebugEnterAlt(1);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:104:17: ',' b+= term
						{
						DebugLocation(104, 17);
						char_literal80=(IToken)Match(input,29,Follow._29_in_array523);  
						stream_29.Add(char_literal80);

						DebugLocation(104, 23);
						PushFollow(Follow._term_in_array529);
						b=term();
						PopFollow();
				...
				char_literal81=(IToken)Match(input,43,Follow._43_in_array532);  
				...
				// 104:36: -> ^( ARRAY $a ( $b)* )
				{
					...
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:104:39: ^( ARRAY $a ( $b)* )
					{
					CommonTree root_1 = (CommonTree)adaptor.Nil();
					...
					adaptor.AddChild(root_1, stream_a.NextTree());
					DebugLocation(104, 51);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:104:51: ( $b)*
					while ( stream_b.HasNext )
					{
						DebugLocation(104, 51);
						adaptor.AddChild(root_1, stream_b.NextTree());
			...
			case 2:
				DebugEnterAlt(2);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:105:4: '[' ']'
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(105, 4);
				char_literal82=(IToken)Match(input,42,Follow._42_in_array550); 
				char_literal82_tree = (CommonTree)adaptor.Create(char_literal82);
				adaptor.AddChild(root_0, char_literal82_tree);
				DebugLocation(105, 7);
				char_literal83=(IToken)Match(input,43,Follow._43_in_array551); 
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:108:1: accessor : a= IDENT ( '[' b+= INTEGER ']' )+ -> ^( ACCESS $a ( $b)+ ) ;
	...
	private AstParserRuleReturnScope<CommonTree, IToken> accessor()
	{
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:109:2: (a= IDENT ( '[' b+= INTEGER ']' )+ -> ^( ACCESS $a ( $b)+ ) )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:109:4: a= IDENT ( '[' b+= INTEGER ']' )+
			{
			DebugLocation(109, 6);
			a=(IToken)Match(input,IDENT,Follow._IDENT_in_accessor566);  
			stream_IDENT.Add(a);

			DebugLocation(109, 14);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:109:14: ( '[' b+= INTEGER ']' )+
			int cnt16=0;
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:109:15: '[' b+= INTEGER ']'
					{
					DebugLocation(109, 15);
					char_literal84=(IToken)Match(input,42,Follow._42_in_accessor569);  
					stream_42.Add(char_literal84);

					DebugLocation(109, 21);
					b=(IToken)Match(input,INTEGER,Follow._INTEGER_in_accessor575);  
					...
					char_literal85=(IToken)Match(input,43,Follow._43_in_accessor577);  
			...
			// 109:38: -> ^( ACCESS $a ( $b)+ )
			{
				...
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:109:41: ^( ACCESS $a ( $b)+ )
				{
				CommonTree root_1 = (CommonTree)adaptor.Nil();
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:116:1: accessorStatement : a= IDENT ( '.' b+= funCallStatement )+ -> ^( FIELD_ACCESS $a ( $b)+ ) ;
	...
	private AstParserRuleReturnScope<CommonTree, IToken> accessorStatement()
	{
		...
		EnterRule("accessorStatement", 17);
		TraceIn("accessorStatement", 17);
		AstParserRuleReturnScope<CommonTree, IToken> retval = new AstParserRuleReturnScope<CommonTree, IToken>();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:117:2: (a= IDENT ( '.' b+= funCallStatement )+ -> ^( FIELD_ACCESS $a ( $b)+ ) )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:117:4: a= IDENT ( '.' b+= funCallStatement )+
			{
			DebugLocation(117, 5);
			a=(IToken)Match(input,IDENT,Follow._IDENT_in_accessorStatement617);  
			stream_IDENT.Add(a);

			DebugLocation(117, 12);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:117:12: ( '.' b+= funCallStatement )+
			int cnt17=0;
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:117:13: '.' b+= funCallStatement
					{
					DebugLocation(117, 13);
					char_literal86=(IToken)Match(input,31,Follow._31_in_accessorStatement620);  
					stream_31.Add(char_literal86);

					DebugLocation(117, 18);
					PushFollow(Follow._funCallStatement_in_accessorStatement624);
					b=funCallStatement();
					PopFollow();
			...
			RewriteRuleSubtreeStream stream_b=new RewriteRuleSubtreeStream(adaptor,"token b",list_b);
			root_0 = (CommonTree)adaptor.Nil();
			// 117:40: -> ^( FIELD_ACCESS $a ( $b)+ )
			{
				DebugLocation(117, 43);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:117:43: ^( FIELD_ACCESS $a ( $b)+ )
				{
				CommonTree root_1 = (CommonTree)adaptor.Nil();
		...
		{
			TraceOut("accessorStatement", 17);
			LeaveRule("accessorStatement", 17);
	...
	// $ANTLR start "term"
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:128:1: term : ( IDENT | '(' expression ')' -> expression | INTEGER | STRING | BOOL | FLOAT );
	[GrammarRule("term")]
	private AstParserRuleReturnScope<CommonTree, IToken> term()
	{
		...
		IToken INTEGER91 = default(IToken);
		IToken STRING92 = default(IToken);
		IToken BOOL93 = default(IToken);
		IToken FLOAT94 = default(IToken);
		...
		CommonTree STRING92_tree = default(CommonTree);
		CommonTree BOOL93_tree = default(CommonTree);
		CommonTree FLOAT94_tree = default(CommonTree);
		RewriteRuleITokenStream stream_25=new RewriteRuleITokenStream(adaptor,"token 25");
		RewriteRuleITokenStream stream_26=new RewriteRuleITokenStream(adaptor,"token 26");
		RewriteRuleSubtreeStream stream_expression=new RewriteRuleSubtreeStream(adaptor,"rule expression");
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:129:2: ( IDENT | '(' expression ')' -> expression | INTEGER | STRING | BOOL | FLOAT )
			int alt18=6;
			...
			case 1:
				DebugEnterAlt(1);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:129:4: IDENT
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(129, 4);
				IDENT87=(IToken)Match(input,IDENT,Follow._IDENT_in_term675); 
			...
			case 2:
				DebugEnterAlt(2);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:130:4: '(' expression ')'
				{
				DebugLocation(130, 4);
				char_literal88=(IToken)Match(input,25,Follow._25_in_term680);  
				stream_25.Add(char_literal88);

				DebugLocation(130, 8);
				PushFollow(Follow._expression_in_term682);
				expression89=expression();
				PopFollow();

				stream_expression.Add(expression89.Tree);
				DebugLocation(130, 19);
				char_literal90=(IToken)Match(input,26,Follow._26_in_term684);  
			...
			case 3:
				DebugEnterAlt(3);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:131:4: INTEGER
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(131, 4);
				INTEGER91=(IToken)Match(input,INTEGER,Follow._INTEGER_in_term693); 
			...
			case 4:
				DebugEnterAlt(4);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:132:5: STRING
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(132, 5);
				STRING92=(IToken)Match(input,STRING,Follow._STRING_in_term699); 
			...
			case 5:
				DebugEnterAlt(5);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:133:4: BOOL
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(133, 4);
				BOOL93=(IToken)Match(input,BOOL,Follow._BOOL_in_term704); 
				BOOL93_tree = (CommonTree)adaptor.Create(BOOL93);
			...
			case 6:
				DebugEnterAlt(6);
				// D:\\Eclipse\\aegiscript_live\\aegiscript.g:134:4: FLOAT
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(134, 4);
				FLOAT94=(IToken)Match(input,FLOAT,Follow._FLOAT_in_term709); 
				FLOAT94_tree = (CommonTree)adaptor.Create(FLOAT94);
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:137:1: negation : ( 'not' ^)* term ;
	...
	private AstParserRuleReturnScope<CommonTree, IToken> negation()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> term96 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:138:2: ( ( 'not' ^)* term )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:138:4: ( 'not' ^)* term
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(138, 9);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:138:9: ( 'not' ^)*
			...
			while (true)
			{
				...
				case 1:
					...
					{
					DebugLocation(138, 9);
					string_literal95=(IToken)Match(input,52,Follow._52_in_negation721); 
			...
			PushFollow(Follow._term_in_negation725);
			term96=term();
			PopFollow();

			adaptor.AddChild(root_0, term96.Tree);
	...
	// $ANTLR start "unary"
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:141:1: unary : ( '+' ^| '-' ^)* negation ;
	[GrammarRule("unary")]
	private AstParserRuleReturnScope<CommonTree, IToken> unary()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> negation99 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:142:2: ( ( '+' ^| '-' ^)* negation )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:142:4: ( '+' ^| '-' ^)* negation
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(142, 4);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:142:4: ( '+' ^| '-' ^)*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:142:5: '+' ^
					{
					DebugLocation(142, 8);
					char_literal97=(IToken)Match(input,28,Follow._28_in_unary739); 
				...
				case 2:
					DebugEnterAlt(2);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:142:12: '-' ^
					{
					DebugLocation(142, 15);
					char_literal98=(IToken)Match(input,30,Follow._30_in_unary744); 
			...
			PushFollow(Follow._negation_in_unary749);
			negation99=negation();
			PopFollow();

			adaptor.AddChild(root_0, negation99.Tree);
	...
	// $ANTLR start "mult"
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:145:1: mult : unary ( ( '*' ^| '/' ^| 'mod' ^) unary )* ;
	[GrammarRule("mult")]
	private AstParserRuleReturnScope<CommonTree, IToken> mult()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> unary100 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> unary104 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:146:2: ( unary ( ( '*' ^| '/' ^| 'mod' ^) unary )* )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:146:4: unary ( ( '*' ^| '/' ^| 'mod' ^) unary )*
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(146, 4);
			PushFollow(Follow._unary_in_mult760);
			unary100=unary();
			PopFollow();

			adaptor.AddChild(root_0, unary100.Tree);
			DebugLocation(146, 10);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:146:10: ( ( '*' ^| '/' ^| 'mod' ^) unary )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:146:11: ( '*' ^| '/' ^| 'mod' ^) unary
					{
					DebugLocation(146, 11);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:146:11: ( '*' ^| '/' ^| 'mod' ^)
					int alt21=3;
					...
					case 1:
						DebugEnterAlt(1);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:146:12: '*' ^
						{
						DebugLocation(146, 15);
						char_literal101=(IToken)Match(input,27,Follow._27_in_mult764); 
					...
					case 2:
						DebugEnterAlt(2);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:146:19: '/' ^
						{
						DebugLocation(146, 22);
						char_literal102=(IToken)Match(input,32,Follow._32_in_mult769); 
					...
					case 3:
						DebugEnterAlt(3);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:146:26: 'mod' ^
						{
						DebugLocation(146, 31);
						string_literal103=(IToken)Match(input,51,Follow._51_in_mult774); 
					...
					PushFollow(Follow._unary_in_mult778);
					unary104=unary();
					PopFollow();

					adaptor.AddChild(root_0, unary104.Tree);
	...
	// $ANTLR start "add"
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:149:1: add : mult ( ( '+' ^| '-' ^) mult )* ;
	[GrammarRule("add")]
	private AstParserRuleReturnScope<CommonTree, IToken> add()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> mult105 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> mult108 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:150:2: ( mult ( ( '+' ^| '-' ^) mult )* )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:150:4: mult ( ( '+' ^| '-' ^) mult )*
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(150, 4);
			PushFollow(Follow._mult_in_add792);
			mult105=mult();
			PopFollow();

			adaptor.AddChild(root_0, mult105.Tree);
			DebugLocation(150, 9);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:150:9: ( ( '+' ^| '-' ^) mult )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:150:10: ( '+' ^| '-' ^) mult
					{
					DebugLocation(150, 10);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:150:10: ( '+' ^| '-' ^)
					int alt23=2;
					...
					case 1:
						DebugEnterAlt(1);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:150:11: '+' ^
						{
						DebugLocation(150, 14);
						char_literal106=(IToken)Match(input,28,Follow._28_in_add796); 
					...
					case 2:
						DebugEnterAlt(2);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:150:18: '-' ^
						{
						DebugLocation(150, 21);
						char_literal107=(IToken)Match(input,30,Follow._30_in_add801); 
					...
					PushFollow(Follow._mult_in_add805);
					mult108=mult();
					PopFollow();

					adaptor.AddChild(root_0, mult108.Tree);
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:153:1: relation : add ( ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^) add )* ;
	...
	private AstParserRuleReturnScope<CommonTree, IToken> relation()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> add109 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> add116 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:2: ( add ( ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^) add )* )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:4: add ( ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^) add )*
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(154, 4);
			PushFollow(Follow._add_in_relation818);
			add109=add();
			PopFollow();

			adaptor.AddChild(root_0, add109.Tree);
			DebugLocation(154, 8);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:8: ( ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^) add )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:9: ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^) add
					{
					DebugLocation(154, 9);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:9: ( '==' ^| '!=' ^| '<' ^| '<=' ^| '>=' ^| '>' ^)
					int alt25=6;
					...
					case 1:
						DebugEnterAlt(1);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:10: '==' ^
						{
						DebugLocation(154, 14);
						string_literal110=(IToken)Match(input,38,Follow._38_in_relation822); 
					...
					case 2:
						DebugEnterAlt(2);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:18: '!=' ^
						{
						DebugLocation(154, 22);
						string_literal111=(IToken)Match(input,23,Follow._23_in_relation827); 
					...
					case 3:
						DebugEnterAlt(3);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:26: '<' ^
						{
						DebugLocation(154, 29);
						char_literal112=(IToken)Match(input,35,Follow._35_in_relation832); 
					...
					case 4:
						DebugEnterAlt(4);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:33: '<=' ^
						{
						DebugLocation(154, 37);
						string_literal113=(IToken)Match(input,36,Follow._36_in_relation837); 
					...
					case 5:
						DebugEnterAlt(5);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:41: '>=' ^
						{
						DebugLocation(154, 45);
						string_literal114=(IToken)Match(input,40,Follow._40_in_relation842); 
					...
					case 6:
						DebugEnterAlt(6);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:154:49: '>' ^
						{
						DebugLocation(154, 52);
						char_literal115=(IToken)Match(input,39,Follow._39_in_relation847); 
					...
					PushFollow(Follow._add_in_relation851);
					add116=add();
					PopFollow();

					adaptor.AddChild(root_0, add116.Tree);
	...
	// D:\\Eclipse\\aegiscript_live\\aegiscript.g:157:1: expression : relation ( ( '&&' ^| '||' ^) relation )* ;
	...
	private AstParserRuleReturnScope<CommonTree, IToken> expression()
	{
		...
		AstParserRuleReturnScope<CommonTree, IToken> relation117 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		AstParserRuleReturnScope<CommonTree, IToken> relation120 = default(AstParserRuleReturnScope<CommonTree, IToken>);
		...
		try
		{
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:158:2: ( relation ( ( '&&' ^| '||' ^) relation )* )
			DebugEnterAlt(1);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:158:4: relation ( ( '&&' ^| '||' ^) relation )*
			{
			root_0 = (CommonTree)adaptor.Nil();

			DebugLocation(158, 4);
			PushFollow(Follow._relation_in_expression865);
			relation117=relation();
			PopFollow();

			adaptor.AddChild(root_0, relation117.Tree);
			DebugLocation(158, 13);
			// D:\\Eclipse\\aegiscript_live\\aegiscript.g:158:13: ( ( '&&' ^| '||' ^) relation )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:158:14: ( '&&' ^| '||' ^) relation
					{
					DebugLocation(158, 14);
					// D:\\Eclipse\\aegiscript_live\\aegiscript.g:158:14: ( '&&' ^| '||' ^)
					int alt27=2;
					...
					case 1:
						DebugEnterAlt(1);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:158:15: '&&' ^
						{
						DebugLocation(158, 19);
						string_literal118=(IToken)Match(input,24,Follow._24_in_expression869); 
					...
					case 2:
						DebugEnterAlt(2);
						// D:\\Eclipse\\aegiscript_live\\aegiscript.g:158:23: '||' ^
						{
						DebugLocation(158, 27);
						string_literal119=(IToken)Match(input,55,Follow._55_in_expression874); 
					...
					PushFollow(Follow._relation_in_expression878);
					relation120=relation();
					PopFollow();

					adaptor.AddChild(root_0, relation120.Tree);
	...
	private static class Follow
	{
		...
		public static readonly BitSet _37_in_constant125 = new BitSet(new ulong[]{0x10000052119040UL});
		...
		public static readonly BitSet _37_in_variable156 = new BitSet(new ulong[]{0x10000052119040UL});
		...
		public static readonly BitSet _50_in_ifStatement186 = new BitSet(new ulong[]{0x10000052119040UL});
		...
		public static readonly BitSet _47_in_elsif212 = new BitSet(new ulong[]{0x10000052119040UL});
		...
		public static readonly BitSet _54_in_whileStatement262 = new BitSet(new ulong[]{0x10000052119040UL});
		...
		public static readonly BitSet _25_in_funCallStatement315 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _expression_in_funCallStatement321 = new BitSet(new ulong[]{0x24000000UL});
		public static readonly BitSet _29_in_funCallStatement324 = new BitSet(new ulong[]{0x10000052119040UL});
		...
		public static readonly BitSet _37_in_assignmentStatement449 = new BitSet(new ulong[]{0x10000052119040UL});
		...
		public static readonly BitSet _IDENT_in_assignmentStatement459 = new BitSet(new ulong[]{0x2000000000UL});
		public static readonly BitSet _37_in_assignmentStatement461 = new BitSet(new ulong[]{0x8000UL});
		public static readonly BitSet _funCallStatement_in_assignmentStatement464 = new BitSet(new ulong[]{0x400000000UL});
		public static readonly BitSet _34_in_assignmentStatement466 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IDENT_in_assignmentStatement472 = new BitSet(new ulong[]{0x2000000000UL});
		public static readonly BitSet _37_in_assignmentStatement474 = new BitSet(new ulong[]{0x8000UL});
		public static readonly BitSet _accessor_in_assignmentStatement477 = new BitSet(new ulong[]{0x400000000UL});
		public static readonly BitSet _34_in_assignmentStatement479 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IDENT_in_assignmentStatement485 = new BitSet(new ulong[]{0x2000000000UL});
		public static readonly BitSet _37_in_assignmentStatement487 = new BitSet(new ulong[]{0x40000000000UL});
		public static readonly BitSet _array_in_assignmentStatement490 = new BitSet(new ulong[]{0x400000000UL});
		public static readonly BitSet _34_in_assignmentStatement492 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IDENT_in_assignmentStatement497 = new BitSet(new ulong[]{0x2000000000UL});
		public static readonly BitSet _37_in_assignmentStatement499 = new BitSet(new ulong[]{0x8000UL});
		public static readonly BitSet _accessorStatement_in_assignmentStatement502 = new BitSet(new ulong[]{0x400000000UL});
		public static readonly BitSet _34_in_assignmentStatement504 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _42_in_array515 = new BitSet(new ulong[]{0x2119040UL});
		public static readonly BitSet _term_in_array520 = new BitSet(new ulong[]{0x80020000000UL});
		public static readonly BitSet _29_in_array523 = new BitSet(new ulong[]{0x2119040UL});
		public static readonly BitSet _term_in_array529 = new BitSet(new ulong[]{0x80020000000UL});
		public static readonly BitSet _43_in_array532 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _42_in_array550 = new BitSet(new ulong[]{0x80000000000UL});
		public static readonly BitSet _43_in_array551 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IDENT_in_accessor566 = new BitSet(new ulong[]{0x40000000000UL});
		public static readonly BitSet _42_in_accessor569 = new BitSet(new ulong[]{0x10000UL});
		public static readonly BitSet _INTEGER_in_accessor575 = new BitSet(new ulong[]{0x80000000000UL});
		public static readonly BitSet _43_in_accessor577 = new BitSet(new ulong[]{0x40000000002UL});
		public static readonly BitSet _IDENT_in_accessorStatement617 = new BitSet(new ulong[]{0x80000000UL});
		public static readonly BitSet _31_in_accessorStatement620 = new BitSet(new ulong[]{0x8000UL});
		public static readonly BitSet _funCallStatement_in_accessorStatement624 = new BitSet(new ulong[]{0x80000002UL});
		public static readonly BitSet _IDENT_in_term675 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _25_in_term680 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _expression_in_term682 = new BitSet(new ulong[]{0x4000000UL});
		public static readonly BitSet _26_in_term684 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _INTEGER_in_term693 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _STRING_in_term699 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _BOOL_in_term704 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _FLOAT_in_term709 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _52_in_negation721 = new BitSet(new ulong[]{0x10000002119040UL});
		public static readonly BitSet _term_in_negation725 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _28_in_unary739 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _30_in_unary744 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _negation_in_unary749 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _unary_in_mult760 = new BitSet(new ulong[]{0x8000108000002UL});
		public static readonly BitSet _27_in_mult764 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _32_in_mult769 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _51_in_mult774 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _unary_in_mult778 = new BitSet(new ulong[]{0x8000108000002UL});
		public static readonly BitSet _mult_in_add792 = new BitSet(new ulong[]{0x50000002UL});
		public static readonly BitSet _28_in_add796 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _30_in_add801 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _mult_in_add805 = new BitSet(new ulong[]{0x50000002UL});
		public static readonly BitSet _add_in_relation818 = new BitSet(new ulong[]{0x1D800800002UL});
		public static readonly BitSet _38_in_relation822 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _23_in_relation827 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _35_in_relation832 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _36_in_relation837 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _40_in_relation842 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _39_in_relation847 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _add_in_relation851 = new BitSet(new ulong[]{0x1D800800002UL});
		public static readonly BitSet _relation_in_expression865 = new BitSet(new ulong[]{0x80000001000002UL});
		public static readonly BitSet _24_in_expression869 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _55_in_expression874 = new BitSet(new ulong[]{0x10000052119040UL});
		public static readonly BitSet _relation_in_expression878 = new BitSet(new ulong[]{0x80000001000002UL});
	}
