    ...
    public static class ASTNodeFactory
    {
        ...
        public static ASTNode CreateNode(CommonTree tree, String tokenType, String content)
        {
            ...
            switch (tokenType)
            {
                ...
                case "'if'":
                    node = new IfNode(tree) {ActualType = ASTNode.Type.If};
                    return node;
                case "'elsif'":
                ...
                case "FIELD_ACCESS":
                    ...
                    return node;
                case "ACCESS":
                    node = new ArrAccessNode(tree, ((CommonTree) tree.Children[0]).Text)
                        {
                ...
                case "'not'":
                    node = new NegationNode(tree) {ActualType = ASTNode.Type.Negation, Dispose = false};
                    return node;
